...
#### Bundled PacketCable MIBs

- Extracted 7 MIB modules from PacketCable specification PDFs covering both 1.0 and 1.5 spec versions
- `PKTC-MTA-MIB` (1.0 and 1.5) -- MTA device management
- `PKTC-SIG-MIB` (1.0 and 1.5) -- NCS/DQoS signaling
- `PKTC-EN-MTA-MIB` (1.5) -- Euro-PacketCable MTA extensions
- `PKTC-EN-SIG-MIB` (1.5) -- Euro-PacketCable signaling extensions
- `PKTC-EVENT-MIB` (1.5) -- PacketCable event reporting
- Versioned filenames with `@YYYY-MM-DD` convention and symlinks to latest revisions
- MIB manifest updated (cablelabs count 246 → 253)
...
[0.1.2]: https://github.com/roc-ops/open-dci/compare/v0.1.1...v0.1.2
